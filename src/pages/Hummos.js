  ...
  return (
    ...
    <div className="myBody">
		<div className="myHead">
			<h1 className="myHead">Houmous (purée de pois chiches)</h1>
		</div>

	<div className="myPic" >
		<div className="imgContainer1" >
	
			<img className="myImg" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Lebanese_style_hummus.jpg/1024px-Lebanese_style_hummus.jpg" alt="Houmous (purée de pois chiches)" />

		</div>
	</div>
	<div className="myPar" >
		<p>Houmous signifie pois-chiche en arabe. Il désigne donc uniquement la purée de pois chiche (à laquelle on mélange le tahini) : </p>
		<p> aucun besoin donc de dire “houmous de pois chiche”.  </p>
	...
	<div className="recipe">
		<h2 className="ingredientsy">Les Ingrédients</h2>
	...
	<div className="recipe">
		<h2 className="processy">Instructions</h2>
